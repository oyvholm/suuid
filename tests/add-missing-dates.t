...
#=======================================================================
# add-missing-dates.t
# File ID: d1a7c016-31a6-11e5-adad-000df06acc56
#
# Test suite for add-missing-dates(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = 'add-missing-dates-stderr.tmp';
    my $retval = 1;
...
Contains tests for the add-missing-dates(1) program.
...
add-missing-dates.t [options] [file [files [...]]]
