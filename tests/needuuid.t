...
#==============================================================================
# needuuid.t
# File ID: d1f38b36-31a6-11e5-852e-000df06acc56
#
# Test suite for needuuid(1).
#
# Character set: UTF-8
...
sub main {
    ...
    testcmd("echo 45a97d24-31ac-11e5-9044-000df06acc56indeed | $CMD",
            ...
            '',
            1,
            'UUID is at start of line from stdin,'
            . ' but there\'s more rubbish before EOL');
...
sub testcmd {
    ...
    my $TMP_STDERR = 'needuuid-stderr.tmp';
    my $retval = 1;
...
Contains tests for the needuuid(1) program.
